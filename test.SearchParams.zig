...
test {
    ...
    var x = try url.SearchParams.initFromString(alloc, "a=b&c=d");
...
test {
    ...
    var x = try url.SearchParams.initFromString(alloc, "e=f&g=h");
...
test {
    ...
    var x = url.SearchParams.init(alloc);
    try x.append("a", "b");
...
test {
    ...
    x = try url.SearchParams.initFromString(alloc, "a=a&b=b&a=a&c=c");
    x.delete("a", null);
    try expect(try x.encode()).toEqualString("b=b&c=c");
    x = try url.SearchParams.initFromString(alloc, "a=a&=&b=b&c=c");
    x.delete("", null);
    try expect(try x.encode()).toEqualString("a=a&b=b&c=c");
    x = try url.SearchParams.initFromString(alloc, "a=a&null=null&b=b");
    x.delete("null", null);
    try expect(try x.encode()).toEqualString("a=a&b=b");
    x = try url.SearchParams.initFromString(alloc, "a=a&undefined=undefined&b=b");
...
test {
    ...
    try expect(x.get("c")).toEqualString("d");
    try expect(x.get("e")).toBeNull();
    x = try url.SearchParams.initFromString(alloc, "a=b&c=d&a=e");
    try expect(x.get("a")).toEqualString("b");
    x = try url.SearchParams.initFromString(alloc, "=b&c=d");
    try expect(x.get("")).toEqualString("b");
    x = try url.SearchParams.initFromString(alloc, "a=&c=d&a=e");
...
test {
    ...
    var x = try url.SearchParams.initFromString(alloc, "first=second&third&&");
    try expect(x.has("first", null)).toEqual(true);
...
test {
    ...
    var x = try url.SearchParams.initFromString(alloc, "a=1&a=2&a=3&a");
...
test {
    ...
    x = try url.SearchParams.initFromString(alloc, "null=a");
...
test {
    ...
    var x = try url.SearchParams.initFromString(alloc, "a=b&a=d&c&e&");
...
test {
    ...
    var x = try url.SearchParams.initFromString(alloc, "a=1&a=2&a=3");
    try expect(x.has("a", null)).toEqual(true);
...
test {
    ...
    var x = try url.SearchParams.initFromString(alloc, "a=1&b=2&a=3");
...
test {
    ...
    x = try url.SearchParams.initFromString(alloc, "id=0&value=%");
...
test {
    ...
    var x = url.SearchParams.init(alloc);
    x = try url.SearchParams.initFromString(alloc, "a=b&c=d&&e&&");
    try expect(try x.encode()).toEqualString("a=b&c=d&e=");
    x = try url.SearchParams.initFromString(alloc, "a = b &a=b&c=d%20");
    try expect(try x.encode()).toEqualString("a+=+b+&a=b&c=d+");
    // The lone "=" _does_ survive the roundtrip.
    x = try url.SearchParams.initFromString(alloc, "a=&a=b");
    try expect(try x.encode()).toEqualString("a=&a=b");
    x = try url.SearchParams.initFromString(alloc, "b=%2sf%2a");
    try expect(try x.encode()).toEqualString("b=%252sf*");
    x = try url.SearchParams.initFromString(alloc, "b=%2%2af%2a");
    try expect(try x.encode()).toEqualString("b=%252*f*");
    x = try url.SearchParams.initFromString(alloc, "b=%%2a");
...
test {
    ...
    var x = try url.SearchParams.initFromString(alloc, "a=b,c");
